...
Generated: `2026-06-23T17:09:49.786104+00:00`
Model lane: `auto`
Preparedness input: `/mnt/data/lancer1977/code/OcbLawnMowing/.devstudio/runtime/codebase-snapshot/preparedness.json`

- Scope roots: `/mnt/data/lancer1977/code/OcbLawnMowing`
...
## Top recommendations
- `/mnt/data/lancer1977/code/OcbLawnMowing` — readiness `76` / priority `62`
  ...
  - Dependency status: `warn`
    - `dotnet` manifests: `LawnMowing.csproj`
